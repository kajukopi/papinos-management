...
export const EcommerceGallery = ((t) => {
  function e(r) {
  ...
  function (t, e, n) {
    ...
    function l(t, e, n) {
      var r = "string" == typeof e,
        ...
        i = t.replace(D, ""),
        a = U[i]
      return a && (i = a), -1 < H.indexOf(i) || (i = t), [r, o, i]
    }
          ...
          : ((g = c(p, e.replace(R, ""))),
            ((y = f
              ? ((_ = t),
                ...
                (E = r),
                function t(e) {
                  for (var n = _.querySelectorAll(S), r = e.target; r && r !== this; r = r.parentNode) for (var o = n.length; o--; ) if (n[o] === r) return t.oneOff && G.off(_, e.type, E), E.apply(r, [e])
                  return null
                })
              : ((b = t),
                (x = n),
                function t(e) {
                  return t.oneOff && G.off(b, e.type, x), x.apply(b, [e])
    ...
    n.r(e), n(27), n(54), n(55), n(35), n(57), n(110), n(37), n(38), n(94), n(95), n(39), n(25), n(40), n(41), n(59), n(60), n(99), n(120), n(122), n(26), n(43), n(124), n(102), n(126), document.documentElement.dir
    var E,
      O,
      w,
      j,
      ...
      T = (n(128), n(68), n(103), n(69), Element.prototype.querySelectorAll),
      P = Element.prototype.querySelector,
      z =
        ((w = new CustomEvent("Bootstrap", {cancelable: !0})),
    ...
    !(function () {
      ...
      ((T = function (t) {
        ...
        var n = null
        try {
          ;(t = t.replace(I, "#".concat(this.id))), (n = this.querySelectorAll(t))
        } finally {
      ...
      G = {
        ...
        trigger: function (t, e, n) {
          ...
          var r,
            ...
            l = null
          return (
            i && L && ((r = L.Event(e, n)), L(t).trigger(r), (c = !r.isPropagationStopped()), (u = !r.isImmediatePropagationStopped()), (s = r.isDefaultPrevented())),
    ...
    var W = function (t, e, n) {
      ...
      it = function (t, e) {
        ...
        return (n = []).concat.apply(n, g(C.call(r, t)))
      },
      at = function (t, e) {
      ...
      ft,
      pt = "ecommerceGallery",
      dt = "psa.ecommerceGallery",
      ht = ".ecommerce-gallery",
      vt = ".lightbox",
      mt = "".concat(vt, " img:not(.lightbox-disabled)"),
      gt = "img:not(.ecommerce-gallery-main-img):not(.ecommerce-disabled)",
      yt = {activation: "string", autoHeight: "boolean", zoomEffect: "(string|boolean)"},
      bt = {activation: "click", autoHeight: !1, zoomEffect: !1},
      xt = (function () {
        function t(e) {
          ...
          !(function (t, e) {
            ...
            (this._animating = !1),
            this._element && k.setData(e, dt, this)
        }
        var e, n, o
        return (
          (e = t),
          ...
          (n = [
            {
              key: "init",
              value: function () {
                this._setGalleryData(), this._lightbox && this._appendLightboxContent(), this._addEvents()
              },
            },
            {
              key: "dispose",
              value: function () {
                this._removeEvents(), k.removeData(this._element, dt), (this._element = null)
              },
            },
            {
              key: "_toggle",
              value: function (t) {
                this._animating || t.target.dataset.psaImg === this._activeImg.src || t.target.src === this._activeImg.src || (this._animationStart(), this._toggleThumbsClass(t), this._toggleMainImg(t))
              },
            },
            {
              key: "_setGalleryData",
              value: function () {
                ;(this._activeImg = at(".ecommerce-gallery-main-img", this._element)), Z(this._activeImg, "active"), (this._lightbox = at(vt, this._element))
              },
            },
            {
              key: "_animationStart",
            ...
            {
              key: "_appendLightboxContent",
              value: function () {
                var t = this
                ;(this._lightbox.innerHTML = ""),
                  this.thumbnails.forEach(function (e) {
                    var n,
                      r = ((n = "img"), document.createElement(n))
                    ;(r.src = e.dataset.psaImg), (r.alt = e.alt), e.dataset.caption && (r.dataset.caption = e.dataset.caption), t.options.autoHeight && Q(r, {height: "auto"}), t._applyLigthboxImgClassList(r, e), t._lightbox.append(r)
                  })
              },
            },
            {
              ...
              value: function () {
                var t = this
                this.thumbnails.forEach(function (e) {
                  ;(t._toggleEvent = t._toggle.bind(t)), $.on(e, t.options.activation, t._toggleEvent)
                }),
                  this._multiCarousel && ((this._updateEventsHandler = this._updateEvents.bind(this)), $.on(this._multiCarousel, "slided.psa.multiCarousel", this._updateEventsHandler)),
                  this._lightbox && ((this._onLightboxSlideHandler = this._onLightboxSlide.bind(this)), $.on(this._lightbox, "slided.psa.lightbox", this._onLightboxSlideHandler)),
                  this.options.zoomEffect &&
                    it("img", this._lightbox).forEach(function (e) {
                      $.on(e, "mousemove", t._onMainImgMousemove), $.on(e, "mouseleave", t._onMainImgMouseleave)
                    })
              },
            },
            {
              ...
              value: function (t) {
                var e = this
                rt(t.target, ht) === this._element &&
                  this.thumbnails.forEach(function (t) {
                    ;(e._toggleEvent = e._toggle.bind(e)), $.on(t, e.options.activation, e._toggleEvent)
                  })
              },
            },
            {
              ...
              value: function () {
                var t = this
                this.thumbnails.forEach(function (e) {
                  $.off(e, t.options.activation, t._toggleEvent)
                }),
                  this._multiCarousel && $.off(this._multiCarousel, "slided.psa.multiCarousel", this._updateEventsHandler),
                  this._lightbox && $.off(this._lightbox, "slided.psa.lightbox", this._onLightboxSlideHandler),
                  this.options.zoomEffect &&
                    it("img", this._lightbox).forEach(function (e) {
                      $.off(e, "mousemove", t._onMainImgMousemove)
                    })
              },
            },
            {
              key: "_onLightboxSlide",
              value: function () {
                var t = psa.Lightbox.getInstance(this._lightbox),
                  e = t.activeImg,
                  n = t.currentImg
                it("img", this._lightbox).forEach(function (t, n) {
                  et(t, "active"), n === e && Z(t, "active")
                }),
                  it(gt, this._element).forEach(function (t) {
                    et(t, "active"), (n.src !== t.src && n.src !== t.dataset.psaImg) || Z(t, "active")
                  })
              },
            },
            {
              key: "_onMainImgMousemove",
              value: function (t) {
                this._activeImg = t.target
                var e = -(t.offsetX - this._activeImg.width / 2) / 2,
                  n = -(t.offsetY - this._activeImg.height / 2) / 2
                Q(this._activeImg, {transform: "scale(4.5) translate(".concat(e, "px, ").concat(n, "px)")})
              },
            },
            {
              key: "_onMainImgMouseleave",
              value: function () {
                Q(this._activeImg, {transform: "scale(1)"})
              },
            },
            {
              key: "_applyLigthboxImgClassList",
              value: function (t, e) {
                this._activeImg.classList.forEach(function (e) {
                  "active" !== e && Z(t, e)
                }),
                  e.classList.contains("active") && Z(t, "active")
              },
            },
            {
              key: "_toggleThumbsClass",
              value: function (t) {
                it(gt, this._element).forEach(function (t) {
                  et(t, "active")
                }),
            ...
            },
            {
              ...
              value: function (t) {
                var e = this
                it("img", this._lightbox).forEach(function (n) {
                  t.target.dataset.psaImg === n.dataset.psaImg || t.target.dataset.psaImg === n.src ? ((e._activeImg = n), e._fadeIn(n)) : e._fadeOut(n)
                })
              },
            },
            {
              key: "_fadeIn",
              value: function (t) {
                ;["animation", "fade-in", "faster", "active"].forEach(function (e) {
                  return Z(t, e)
                }),
                  setTimeout(function () {
                    ;["animation", "fade-in", "faster"].forEach(function (e) {
                      return et(t, e)
                    })
                  }, 500)
              },
            },
            {
              ...
              value: function (t) {
                t.classList.contains("active") &&
                  (["animating", "animation", "fade-out", "faster"].forEach(function (e) {
                    return Z(t, e)
                  }),
                  setTimeout(function () {
                    ;["animation", "animating", "fade-out", "faster", "active"].forEach(function (e) {
                      return et(t, e)
                    })
                  }, 500))
              },
            },
            {
              key: "options",
              get: function () {
                var t = _(_(_({}, bt), Y(this._element)), this._options)
                return r(pt, t, yt), t
              },
            },
            {
              ...
              get: function () {
                var t = []
                return (
                  it(gt, this._element).forEach(function (e) {
                    t.push(e)
                  }),
                  t
                )
            ...
            },
            {
              key: "_multiCarousel",
              get: function () {
                return at(".multi-carousel", this._element)
              },
            },
          ]) && S(e.prototype, n),
          o && S(e, o),
    ...
    it(ht).forEach(function (t) {
      new xt(t).init()
    }),
      it(vt).forEach(function (t) {
        var e = psa.Lightbox.getInstance(t)
        e && e.dispose(), new psa.Lightbox(t).init()
      }),
      $.on(document, "click", mt, psa.Lightbox.toggle()),
      (ft = function () {
        var t,
          e = o()
        e &&
          ((t = e.fn[pt]),
          (e.fn[pt] = xt.jQueryInterface),
          (e.fn[pt].Constructor = xt),
          (e.fn[pt].noConflict = function () {
            return (e.fn[pt] = t), xt.jQueryInterface
          }))
      }),
