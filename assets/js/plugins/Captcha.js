        ...
        function (t, e, n) {
          ...
          var B = o(),
            ...
            J = function (t, e) {
              ...
              return (n = []).concat.apply(n, y(Element.prototype.querySelectorAll.call(r, t)))
            },
            Z = function (t, e) {
            ...
            tt = function (t, e) {
              var n,
                r = (n = []).concat.apply(n, y(t.children))
            ...
            it = "psa.captcha",
            at = ".".concat(it),
            ct = "onExpire".concat(at),
            ut = "onError".concat(at),
            st = "onSuccess".concat(at),
            lt = {sitekey: "", theme: "light", size: "normal", tabindex: 0, lang: "en"},
            ft = {sitekey: "string", theme: "string", size: "string", tabindex: "number", lang: "string"},
            pt = ".".concat(ot),
            dt = (function () {
              function t(e) {
                ...
                !(function (t, e) {
                  ...
                  this._element && (A.setData(e, it, this), this._init())
              }
              var e, n, o
              return (
                (e = t),
                ...
                (n = [
                  {
                    key: "_getConfig",
                    value: function (t) {
                      var e = S(S(S({}, lt), P(this._element)), t)
                      return r(ot, e, ft), e
                    },
                  },
                  {
                  ...
                  },
                  {
                    key: "getResponse",
                    value: function () {
                      return null === this._instance ? null : window.grecaptcha.getResponse(this._instance)
                    },
                  },
                  {
                    key: "onExpire",
                  ...
                  },
                  {
                    key: "onError",
                    value: function () {
                      q.trigger(this._element, ut)
                    },
                  },
                  {
                    key: "onSuccess",
                    value: function () {
                      q.trigger(this._element, st)
                    },
                  },
                  {
                    key: "_init",
          ...
          J(pt).forEach(function (t) {
            dt.getInstance(t) || new dt(t)
          }),
            i(function () {
              var t,
                e = o()
              e &&
                ((t = e.fn[ot]),
                (e.fn[ot] = dt.jQueryInterface),
                (e.fn[ot].Constructor = dt),
                (e.fn[ot].noConflict = function () {
                  return (e.fn[ot] = t), dt.jQueryInterface
                }))
            }),
            (e.default = dt)
        },
