    ...
    (t.m = e =
      [
        ...
        function (t, e, n) {
          ...
          n.r(e), n(45), n(60), n(63), n(67), n(69), n(75)
          var o = (function () {
            function t() {
              !(function (t, e) {
              ...
              (o = [
                {
                  ...
                  value: function (t, e, n) {
                    ...
                    return (
                      ...
                      "number" == typeof n &&
                        ((r = this.get("expiryList") || []),
                        (n = new Date(Number(new Date()) + 1e3 * n * 60 * 60 * 24)),
                        this.isPresentOnExpiryList(t)
                          ? ((o = r.findIndex(function (e) {
                              return void 0 !== e[t]
                            })),
                            (r[o][t] = n))
                          : r.push(((c = n), (a = t) in (i = {}) ? Object.defineProperty(i, a, {value: c, enumerable: !0, configurable: !0, writable: !0}) : (i[a] = c), i)),
                        localStorage.setItem("expiryList", JSON.stringify(r))),
                      "".concat(t, ": ").concat(e, ", expiries: ").concat(n)
                    )
                  },
                },
                {
                ...
                },
                {
                  key: "remove",
                  value: function (t) {
                    this.checkExpiry(), localStorage.removeItem(t)
                    var e,
                      n = this.get("expiryList") || []
                    this.isPresentOnExpiryList(t) &&
                      ((e = n.filter(function (e) {
                        return Object.keys(e)[0] !== t
                      })),
                      localStorage.setItem("expiryList", JSON.stringify(e)))
                  },
                },
                {
                  key: "isPresentOnExpiryList",
                  value: function (t) {
                    return (this.get("expiryList") || []).some(function (e) {
                      return void 0 !== e[t]
                    })
                  },
                },
                {
                  ...
                  value: function (t, e, n) {
                    var r = this,
                      o = (this.get("expiryList") || []).filter(function (e) {
                        return Object.keys(e)[0] === t
                      })
                    e *= 6e3
                    var i = setInterval(function () {
                      new Date(o[0][t]) < new Date() && (n(), clearInterval(i)), r.checkExpiry()
                    }, e)
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    t.filter(function (t) {
                      var n = Object.keys(t)
                      return e > new Date(t[n]) && localStorage.removeItem(n[0]), t[n] >= e
                    })
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e,
                      n = this
                    null !== this.get("is-first-visit") ||
                      ((e = document.getElementById(t)) &&
                        (new psa.Modal(e).show(),
                        e.addEventListener("hidden.bs.modal", function () {
                          n.set("is-first-visit", !1)
                        })))
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    var n,
                      r = (Number(this.get("visit-counter")) || 0) + 1
                    this.set("visit-counter", r), r !== e || ((n = document.getElementById(t)) && new psa.Modal(n).show())
                  },
                },
                {
                  key: "NAME",
