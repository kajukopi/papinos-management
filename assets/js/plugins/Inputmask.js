    ...
    (t.m = e =
      [
        ...
        function (t, e, n) {
          ...
          n.r(e), n(29), n(54), n(55), n(56), n(111), n(38), n(39), n(115), n(116), n(95), n(96), n(41), n(27), n(98), n(18), n(28), n(43), n(61), n(44), n(65), n(66), n(67), n(103), n(125), n(127), n(128), document.documentElement.dir
          var O,
            w,
            j =
              ((O = {}),
          ...
          var k,
            ...
            H = (n(135), n(104), Element.prototype.querySelectorAll),
          ...
          var V = H,
            ...
            dt = "input-mask",
            ht = "psa.".concat(dt),
            vt = "[data-psa-".concat(dt, "]"),
            mt = "complete.".concat(ht),
            gt = "input.".concat(ht),
            yt = {9: {validator: /\d/, symbol: "9"}, a: {validator: /[a-zżźąćśńółę]/i, symbol: "a"}, "*": {validator: /[a-zżźąćśńółę0-9]/i, symbol: "*"}},
            bt = {inputMask: "", charPlaceholder: "_", inputPlaceholder: !0, maskPlaceholder: !1, clearIncomplete: !0, customMask: "", customValidator: ""},
            xt = {inputMask: "string", charPlaceholder: "string", inputPlaceholder: "boolean", maskPlaceholder: "boolean", clearIncomplete: "boolean", customMask: "string", customValidator: "string"},
            _t = (function () {
              function t(e) {
                var n = this,
                ...
                !(function (t, e) {
                  ...
                  E(this, "_setCaretPosition", function (t, e) {
                    "focus" === e
                      ? setTimeout(function () {
                          n._element.setSelectionRange(t, t, "none")
                        }, 0)
                      : n._element.setSelectionRange(t, t, "none")
                  }),
                  (this._element = e),
                  ...
                  (this._isEmpty = !0),
                  (this._isCompleted = !1),
                  this._element && (A.setData(e, ht, this), this._init())
              }
              var e, n, o
              return (
                (e = t),
                ...
                (n = [
                  {
                    key: "dispose",
                    value: function () {
                      this._unbindEvents(), B(this._element, "active"), A.removeData(this._element, ht), (this._element = null)
                    },
                  },
                  {
                    key: "_getConfig",
                    value: function (t) {
                      var e,
                        ...
                        o = I(this._element)
                      return (
                        "number" == typeof o.inputMask && (o.inputMask = String(o.inputMask)),
                        (t = _(_(_(_({}, bt), o), t), {}, {masks: _({}, yt)})),
                        o.customMask && o.customValidator
                          ? ((e = this._getCustomMasks(o.customMask, o.customValidator)), (this._customMasks = e))
                          : t.customMask && t.customValidator && ((n = this._getCustomMasks(t.customMask, t.customValidator)), (this._customMasks = n)),
                        (t.masks = _(_({}, t.masks), this._customMasks)),
                        r(dt, t, xt),
                        t
                      )
                    },
                  },
                  {
                    key: "_init",
                    value: function () {
                      this._options.inputPlaceholder && this._uncoverPlaceholder(), this._bindEvents()
                    },
                  },
                  {
                    key: "_isArray",
                  ...
                  {
                    key: "_isValidMaskChar",
                    value: function (t) {
                      return void 0 !== this._masks[t]
                    },
                  },
                  {
                    key: "_uncoverPlaceholder",
                    value: function () {
                      ;(this._element.value = ""), N(this._element, "active"), (this._element.placeholder = this._options.inputMask)
                    },
                  },
                  {
                    key: "_createInputPlaceholderFromMask",
                    value: function () {
                      var t = this
                      return this._options.inputMask
                        .split("")
                        .map(function (e, n) {
                          return t._isValidMaskChar(e) ? t._getInputPlaceholderChar(n) : e
                        })
                        .join("")
                    },
                  },
                  {
                    ...
                    value: function (t, e) {
                      ...
                      return (
                        (t = t.split(",")),
                        (e = e.split(",")),
                        this._isArray(t) && this._isArray(e)
                          ? t.forEach(function (t, r) {
                              n = _(_({}, n), {}, E({}, t, {validator: e[r], mask: t}))
                            })
                          : (n = _(_({}, n), {}, E({}, t, {validator: e, mask: t}))),
                        n
                      )
                    },
                  },
                  {
                    key: "_getInputPlaceholderChar",
                    value: function (t) {
                      return 1 === this._options.charPlaceholder.length ? this._options.charPlaceholder : this._options.charPlaceholder[t]
                    },
                  },
                  {
                    key: "_getMaskRegex",
                    value: function (t) {
                      if (!this._masks[t]) return !1
                      var e = this._masks[t].validator
                      return this._customMasks && void 0 !== this._customMasks[t] ? new RegExp(e) : e
                    },
                  },
                  {
                    key: "_setInputPlaceholderFromMask",
                    value: function (t) {
                      ;(this._element.value = t), (this._inputPlaceholder = t)
                    },
                  },
                  {
                    key: "_validateInputWithMask",
                    value: function (t) {
                      if (((this._isCompleted = !1), (this._isEmpty = !1), !this._options.inputMask)) return t
                      var e = "^([^".concat(Object.keys(this._masks).join(""), "]+)"),
                        e = new RegExp(e),
                        n = this._calculatePositionAndDirection(t),
                        r = n.isDeleting,
                        o = n.isFirstWithMask,
                        i = n.isFirstWithoutMask
                      !r && (o || i) && e.test(this._options.inputMask) && (t = e.exec(this._options.inputMask)[0] + t)
                      for (var a = this._options.inputMask.length, c = "", u = 0, s = 1; s && u < a; ++u) {
                        var l = t.charAt(u),
                          f = this._options.inputMask.charAt(u)
                        this._isValidMaskChar(f) ? (this._getMaskRegex(f).test(l) ? (c += l) : (s = 0)) : ((c += f), l && l !== f && (t = "".concat(t)))
                      }
                      return (
                        (this._futureCaretPosition = r ? c.length - this._calculateCaretJump(c) : c.length),
                        c.length === a && this._handleComplete(c),
                        0 === c.length && (this._isEmpty = !0),
                        rt.trigger(this._element, gt, {value: c}),
                        c + this._calculatePlaceholderRest(c, a)
                      )
                    },
                  },
                  {
                    key: "_calculatePositionAndDirection",
                    value: function (t) {
                      var e = t.length,
                        n = this._previousValue.length,
                        r = e - this._inputPlaceholder.length,
                        o = this._element.selectionEnd
                      return {isFirstWithMask: this._options.maskPlaceholder && 1 == r && 1 === o, isFirstWithoutMask: !this._options.maskPlaceholder && 1 === e, isDeleting: e - n < 0}
                    },
                  },
                  {
                    key: "_calculatePlaceholderRest",
                    value: function (t, e) {
                      var n = ""
                      if (this._options.maskPlaceholder) for (var r = t.length; r < e; r++) this._inputPlaceholder[r] === this._getInputPlaceholderChar(r) ? (n += this._getInputPlaceholderChar(r)) : (n += this._inputPlaceholder[r])
                      return n
                    },
                  },
                  {
                    key: "_calculateCaretJump",
                    value: function (t) {
                      for (var e = t.length - 1, n = 0, r = e; 0 <= r; r--) {
                        var o = this._getMaskRegex(this._options.inputMask.charAt(r))
                        t.charAt(r) && !o ? n++ : (r = -1)
                      }
                      return e < n && (this._isEmpty = !0), n
                    },
                  },
                  {
                    key: "_bindEvents",
                    value: function () {
                      rt.on(this._element, "input", this._handleInput.bind(this)), rt.on(this._element, "focus", this._handleFocus.bind(this)), rt.on(this._element, "blur", this._handleBlur.bind(this))
                    },
                  },
                  {
                    key: "_unbindEvents",
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      e && e !== this._previousValue && e.length !== this._previousValue.length && (e = e.length < this._previousValue.length && !this._options.maskPlaceholder ? e : this._validateInputWithMask(e)),
                  ...
                  },
                  {
                    key: "_handleComplete",
                    value: function (t) {
                      ;(this._isCompleted = !0), rt.trigger(this._element, mt, {value: t})
                    },
                  },
                  {
                    key: "_handleFocus",
                    value: function () {
                      var t
                      this._previousValue
                        ? ((this._element.value = this._previousValue), this._setCaretPosition(this._futureCaretPosition, "focus"))
                        : this._options.maskPlaceholder && ((t = this._createInputPlaceholderFromMask()), this._setInputPlaceholderFromMask(t), this._setCaretPosition(0, "focus"))
                    },
                  },
                  {
                    key: "_handleBlur",
                    value: function () {
                      ;((this._options.clearIncomplete && !this._isCompleted) || (this._options.inputPlaceholder && (this._isEmpty || 0 === this._element.value.length))) && ((this._previousValue = ""), this._uncoverPlaceholder())
                    },
                  },
                ]) && S(e.prototype, n),
                o && S(e, o),
