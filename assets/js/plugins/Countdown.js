    ...
    (t.m = e =
      [
        ...
        function (t, e, n) {
          ...
          function f(t, e) {
            return (e && "".concat(e, "::").concat(tt++)) || t.uidEvent || tt++
          }
          function p(t) {
            var e = f(t)
          ...
          function h(t, e, n) {
            var r = "string" == typeof e,
              ...
              i = t.replace(Q, ""),
              a = et[i]
            return a && (i = a), -1 < nt.indexOf(i) || (i = t), [r, o, i]
          }
                ...
                : ((g = f(c, e.replace(X, ""))),
                  ((y = a
                    ? ((_ = t),
                      ...
                      (E = r),
                      function t(e) {
                        for (var n = _.querySelectorAll(S), r = e.target; r && r !== this; r = r.parentNode) for (var o = n.length; o--; ) if (n[o] === r) return t.oneOff && rt.off(_, e.type, E), E.apply(r, [e])
                        return null
                      })
                    : ((b = t),
                      (x = n),
                      function t(e) {
                        return t.oneOff && rt.off(b, e.type, x), x.apply(b, [e])
          ...
          var w,
            ...
            A =
              ...
              {
                set: function (t, e, n) {
                  void 0 === t[e] && ((t[e] = {key: e, id: j}), j++), (w[t[e].id] = n)
                },
                get: function (t, e) {
                  if (!t || void 0 === t[e]) return null
                  var n = t[e]
                  return n.key === e ? w[n.id] : null
                },
                delete: function (t, e) {
                  var n
                  void 0 === t[e] || ((n = t[e]).key === e && (delete w[n.id], delete t[e]))
                },
              }),
            k = {
          ...
          var T,
            ...
            G = (n(137), Element.prototype.querySelectorAll),
          ...
          var Y = G,
            ...
            ct = function (t, e) {
              ...
              return (n = []).concat.apply(n, g(Y.call(r, t)))
            },
            ut = function (t, e) {
            ...
            ht = "countdown",
            vt = "psa.".concat(ht),
            mt = "".concat(ht, "-unit-separator"),
            gt = "start.".concat(vt),
            yt = "end.".concat(vt),
            bt = "[data-psa-".concat(ht, "]"),
            xt = ".".concat(ht, "-unit"),
            _t = {countdown: "", countdownSeparator: "", countdownPosition: "horizontal", countdownLabelPosition: "vertical", countdownTextStyle: "", countdownLabelStyle: "", countdownTextSize: "", countdownInterval: 0},
            St = {countdown: "string", countdownSeparator: "", countdownPosition: "string", countdownLabelPosition: "string", countdownTextStyle: "string", countdownLabelStyle: "string", countdownTextSize: "string", countdownInterval: "number"},
            Et = (function () {
              function t(e) {
                ...
                !(function (t, e) {
                  ...
                  (this._isCounting = !1),
                  this._element && (k.setData(e, vt, this), this._init())
              }
              var e, n, o
              return (
                (e = t),
                ...
                (n = [
                  {
                    key: "dispose",
                    value: function () {
                      k.removeData(this._element, vt), this._stopCounting(), (this._dateDistance = null), (this._element.innerHTML = ""), (this._element = null)
                    },
                  },
                  {
                    key: "stop",
                    value: function () {
                      clearInterval(this._countingInterval), (this._countingInterval = null), (this._isCounting = !1), (this._previousDistance = 0), ot.trigger(this._element, yt)
                    },
                  },
                  {
                    key: "start",
                    value: function () {
                      ot.trigger(this._element, gt), (this._dateDistance = this._checkDateDistance()), (this._isCounting = !0), this._startInterval()
                    },
                  },
                  {
                    key: "setCountdownDate",
                    value: function (t) {
                      this._isValidDate(this._options.countdown)
                        ? (this._countdownDate = new Date(t).getTime())
                        : (this._element.innerHTML = '\n        <p class="note note-danger">\n          <strong>Invalid Date Format: '.concat(
                            this._options.countdown,
                            "</strong>. Please provide\n          <a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/parse#ECMAScript_5_ISO-8601_format_support' target=\"_blank\">valid date format</a>\n        </p>\n      "
                          ))
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var t = this,
                        e = ct(xt, this._element)
                      if (
                        (e.forEach(function (e) {
                          F(e, "countdown-unit-".concat(t._options.countdownLabelPosition))
                        }),
                        F(this._element, "countdown"),
                        F(this._element, "countdown-".concat(this._options.countdownPosition)),
                        "" !== this._options.countdownSeparator && !this._options.countdownPosition.includes("vertical"))
                      )
                        for (var n = 0; n < e.length - 1; n++) e[n].insertAdjacentHTML("afterend", "<span class=".concat(mt, ">").concat(this._options.countdownSeparator, "</span>"))
                    },
                  },
                  {
                    key: "_handleInterval",
                    value: function () {
                      var t = this,
                        e = this._options.countdown,
                        n = 1e3 * this._options.countdownInterval
                      ot.on(this._element, yt, function () {
                        var r,
                          o = new Date(Date.now()).getTime(),
                          i = new Date(e).getTime() + n,
                          a = 0
                        ;(a = i < o ? o + (n < (r = o - i) ? n - (r % n) : n - r) : i), t.setCountdownDate(a), t.start()
                      })
                    },
                  },
                  {
                    key: "_init",
                    value: function () {
                      this._setCountDownDate(this._options.countdown), this._startCounting(), 0 < this._options.countdownInterval && this._handleInterval()
                    },
                  },
                  {
                    key: "_setCountDownDate",
                    value: function (t) {
                      this._isValidDate(this._options.countdown)
                        ? (this._countdownDate = new Date(t).getTime())
                        : (this._element.innerHTML = '\n        <p class="note note-danger">\n          <strong>Invalid Date Format: '.concat(
                  ...
                  },
                  {
                    key: "_startCounting",
                    value: function () {
                      ot.trigger(this._element, gt), (this._isCounting = !0), this._createCounter(), this._setStyles(), this._startInterval()
                    },
                  },
                  {
                    key: "_startInterval",
                    value: function () {
                      ...
                      this._updateCounter(this._dateDistance),
                        (this._countingInterval = setInterval(function () {
                          ;(t._dateDistance = t._checkDateDistance()), t._isCounting && t._dateDistance ? t._updateCounter(t._dateDistance) : t._stopCounting()
                        }, 1e3))
                    },
                  },
                  {
                    key: "_isValidDate",
                    value: function (t) {
                      return (t = new Date(t)) instanceof Date && !isNaN(t)
                    },
                  },
                  {
                    key: "_checkDateDistance",
                    value: function () {
                      var t = new Date().getTime(),
                        e = this._countdownDate - t
                      return !(e < 0) && (0 !== this._previousDistance && 1e3 < this._previousDistance - e && (e = this._previousDistance - 1e3), (this._previousDistance = e))
                    },
                  },
                  {
                    key: "_createCounter",
                    value: function () {
                      var t = this,
                        e = this._checkDateDistance(),
                        n = this._calculateTime(e)
                      Object.entries(n).forEach(function (e) {
                        var n,
                          r = x(e, 2),
                          o = r[0],
                          i = r[1],
                          a = ut(".countdown-".concat(o), t._element)
                        a && ((n = t._generateUnitTemplate(a, o, i)), (a.innerHTML = n), z(a, o, i), I(a, "countdownLabel"))
                      })
                    },
                  },
                  {
                    ...
                    value: function (t) {
                      var e = this,
                        n = this._calculateTime(t)
                      Object.entries(n).forEach(function (t) {
                        var n = x(t, 2),
                          r = n[0],
                          o = n[1],
                          i = ut(".countdown-".concat(r), e._element)
                        if (i) {
                          var a = ut("[data-psa-countdown-value]", i)
                          if (a.textContent === o) return
                          ;(a.textContent = o), z(i, r, o)
                        }
                      })
                    },
                  },
                  {
                    key: "_calculateTime",
                    value: function (t) {
                      return {days: this._formatTime(Math.floor(t / 864e5)), hours: this._formatTime(Math.floor((t % 864e5) / 36e5)), minutes: this._formatTime(Math.floor((t % 36e5) / 6e4)), seconds: this._formatTime(Math.floor((t % 6e4) / 1e3))}
                    },
                  },
                  {
                    key: "_formatTime",
                    value: function (t) {
                      return 9 < t ? "".concat(t) : "0".concat(t)
                    },
                  },
                  {
                    key: "_generateUnitTemplate",
                    value: function (t, e, n) {
                      var r,
                        o,
                        i = M(t, "countdownLabel"),
                        a = "label-".concat(e),
                        c = 'aria-labelledby="'.concat(a, '"'),
                        u = "" !== this._options.countdownTextStyle ? 'class="'.concat(this._options.countdownTextStyle, '"') : "",
                        s = "",
                        l = ""
                      return (
                        "" !== this._options.countdownTextSize &&
                          ((r = this._options.countdownTextSize.match(/\d+/)[0]),
                          (o = this._options.countdownTextSize.split(r)[1]),
                          (s = 'style="font-size: '.concat(r / 4).concat(o, '"')),
                          (l = 'style="font-size: '.concat(this._options.countdownTextSize, '"'))),
                        "\n      <span "
                          .concat(i ? c : "", " data-psa-countdown-value ")
                          .concat(u, " ")
                          .concat(l, ">")
                          .concat(n, "</span>\n      ")
                          .concat(i ? '<span name="'.concat(a, '" data-psa-countdown-label class="').concat(this._options.countdownLabelStyle, '" ').concat(s, ">").concat(i, "</span>") : "", "\n    ")
                      )
                    },
                  },
                  {
          ...
          ct(bt).forEach(function (t) {
            return Et.getInstance(t) || new Et(t)
          }),
            (dt = function () {
              var t,
                e = o()
              e &&
                ((t = e.fn[ht]),
                (e.fn[ht] = Et.jQueryInterface),
                (e.fn[ht].Constructor = Et),
                (e.fn[ht].noConflict = function () {
                  return (e.fn[ht] = t), Et.jQueryInterface
                }))
            }),
            "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", dt) : dt(),
            (e.default = Et)
        },
      ]),
    (t.c = n),
